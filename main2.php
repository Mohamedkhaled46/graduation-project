...
<head>
  ...
  <link rel="stylesheet" href="css/mainse.css">
...
<header>
        <div class="logo">
        <h1 class="text-light"><a href="main2.php">Eye cell</a></h1>
        </div>
...
$result = mysqli_query($con,"SELECT name_arabic, name_latin, group_name , type, number, box_no ,photo , description FROM sectors");
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form>
          ...
          <div class="form-group">
            <label for="message-text" class="col-form-label">Amount of sector</label>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
        <script type="text/javascript" >
            $(document).ready(function(){
                $("Eyecell").ketup(function(){ //ال eye cell دي هي اسم الكويري الي هتتعرض
                        var input = $(this).val();
                        if(input != ""){
                            $.ajax({
                                   url:"main2.php",
